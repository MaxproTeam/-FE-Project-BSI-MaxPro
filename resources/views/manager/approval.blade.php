...
<div class="mt-32 px-4">
    <div class="px-4">
        <div class="flex items-center gap-2">
            ...
            <p class="text-sm text-black">></p>
            <p class="text-sm font-bold text-black text-opacity-50">PT. Krama Yudha Tiga Belas</p>
        </div>
        <p class="font-bold text-orange-30 mt-1 text-2xl">PT. Krama Yudha Tiga Belas</p>
        ...
        <div class="flex items-center gap-1 mt-6">
            ...
            <p class="text-xs font-medium text-black">13 PIC</p>
        </div>
        <p class="text-xs font-medium text-black">Supervisor : Andi</p>

        <div class="w-full border-t-2 mt-7 border-black opacity-10"></div>
    </div>

    @include('manager.Components.Card.approval')
</div>
