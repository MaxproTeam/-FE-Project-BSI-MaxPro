    ...
    <div class="px-4">
        <div class="bg-white w-full rounded-t-[20px] pt-[10px] pb-3 px-5" style="box-shadow: 0px 0px 4px 0px #00000040;">
            <div class="flex items-center justify-between">
                <select class="custom-select font-semibold text-black text-[15px] pr-4" id="monthSelect2">
                </select>
...
<script async>
    ...
    const select2 = document.getElementById('monthSelect2');
    const currentDate2 = new Date();

    for (let i = 0; i < 5; i++) {
        let futureDate = new Date(currentDate2.getFullYear(), currentDate2.getMonth() + i, 1);
        let month = monthNames2[futureDate.getMonth()];
