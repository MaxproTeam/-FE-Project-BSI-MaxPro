<div class="mt-7 px-4">
    <div class="hidden" id="dashboard-event">
        ...
        <div class="flex items-center justify-between mt-6">
            <button class="border-2 font-medium border-green-30 bg-white text-green-30 py-1.5 px-3 rounded-xl text-xs active:bg-green-30 active:text-white">
                Lihat Semua
            </button>
    ...
    <div class="flex flex-col gap-y-[18px] mt-[18px]">
        <div class="bg-white p-3 pb-5 rounded-xl drop-shadow-lg">
            ...
            <p class="poppins text-black font-medium text-base mt-4">Event HUT RI - Setup Ruangan</p>
            <div class="flex items-end justify-between">
                <div>
                    <p class="poppins text-[#1E1E1E] text-opacity-80 font-medium text-xs mt-4 flex items-center gap-1">
                        PT. Krama Yudha Tiga Belas
                    </p>
