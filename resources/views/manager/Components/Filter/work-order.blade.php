<div class="flex items-center justify-start gap-3 px-4 mt-4 whitespace-nowrap w-full overflow-x-auto">
    ...
    <button id="filter-semua" data-value="semua" class="border-[1px] border-orange-30 bg-orange-30 text-white py-1.5 px-3 rounded-2xl text-xs">Semua</button>

    <button id="filter-belum-disetujui" data-value="belum-disetujui" class="border-[1px] border-orange-30 py-1.5 px-3 rounded-2xl text-xs">Belum disetujui</button>

    <button id="filter-ditolak" data-value="ditolak" class="border-[1px] border-orange-30 py-1.5 px-3 rounded-2xl text-xs">Ditolak</button>

    <button id="filter-dipending" data-value="dipending" class="border-[1px] border-orange-30 py-1.5 px-3 rounded-2xl text-xs">Dipending</button>
</div>
