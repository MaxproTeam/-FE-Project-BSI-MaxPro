...
<script>
    if(@json(Request::is('work-order-client'))) {
        window.isCalendarForWorkOrderClient = true;
    } else if (@json(Request::is('present-client-supervisor'))) {
        window.isCalendarForSPVAttedancesClient = true;
    } else if (@json(Request::is('present-client-pic'))) {
        window.isCalendarForPICAttedancesClient = true;
    }
</script>