<div class="flex items-center justify-between px-4 mt-4">
    ...
    <button id="filter-belum-ditugaskan" data-value="belum-ditugaskan" class="border-[1px] border-orange-30 py-1.5 px-3 rounded-2xl text-xs">Belum ditugaskan</button>
    <button id="filter-sudah-ditugaskan" data-value="sudah-ditugaskan" class="border-[1px] border-orange-30 py-1.5 px-3 rounded-2xl text-xs">Sudah ditugaskan</button>
</div>
