<div class="px-4 mt-8">
    <div class="flex flex-col gap-y-[18px] mt-[18px]">
        <div class="bg-white p-3 rounded-xl drop-shadow-lg flex items-end justify-between">
            ...
            <button class="bg-green-10 text-white w-[147px] h-10 text-sm rounded-2xl font-bold sm:active:bg-gray-700 active:scale-95 transition-all duration-100 ease-in-out">Cek Pekerjaan</button>
        </div>
        ...
        <div class="bg-white p-3 rounded-xl drop-shadow-lg flex items-end justify-between">
            ...
            <button onclick="window.location.href='/work-check-spv'" class="bg-green-10 text-white w-[147px] h-10 text-sm rounded-2xl font-bold sm:active:bg-gray-700 active:scale-95 transition-all duration-100 ease-in-out">Selengkapnya</button>
        </div>
    </div>
</div>